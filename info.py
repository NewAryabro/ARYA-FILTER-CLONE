...
PICS = (environ.get('PICS', 'https://graph.org/file/d22e35eb1d29e1d9ffb21.jpg')).split() #SAMPLE PIC
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6081617163').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002009379876 -1002129412433') # give your force subscribe channel id here else leave it blank
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://animefrnd44:Ig0kIRF69y9IVXrJ@cluster0.fagqdot.mongodb.net/?retryWrites=true&w=majority") # Necessary If clone mode is true
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "blonde-sheeree-clonemawa-0e7f9dcc.koyeb.app/")
